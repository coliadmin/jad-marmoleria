...
export async function HeroV4() {
  ...
  <div className="absolute inset-0 -z-10 grid gap-1 md:grid-cols-2 xl:grid-cols-3">
    <div className="relative hidden md:inline-flex">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-28 bg-gradient-to-t from-zinc-900/65 via-zinc-900/30 to-transparent z-0" />
      <H3 className="absolute right-10 bottom-10 border-b border-b-border text-muted drop-shadow-md z-10">
        {p1.name.split("(")[0]}{" "}
      </H3>
    </div>
    <div className="relative">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-28 bg-gradient-to-t from-zinc-900/65 via-zinc-900/30 to-transparent z-0" />
      <H3 className="absolute hidden md:block right-10 bottom-10 border-b border-b-border text-muted drop-shadow-md z-10">
        {p2.name.split("(")[0]}{" "}
      </H3>
    </div>
